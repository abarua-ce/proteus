...
# Attach velocity field

coefficients.velocityFieldAsFunction = velocityFieldAsFunction
coefficients.variableNames = ['u']
print("VelocityFieldAsFunction attached to coefficients:", coefficients.velocityFieldAsFunction)
