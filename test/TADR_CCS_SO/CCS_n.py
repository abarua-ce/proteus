...
if not galerkin:
    timeIntegration = Richards_sat.ThetaScheme
timeOrder = 1
#stepController = Min_dt_controller
nonlinearIterationsFloor = 5 # 6
nonlinearIterationsCeil  = 10 #12
...
# PETSc Linear Solver Options
linear_solver_options_prefix = ''  # No prefix
petscOptions = {
