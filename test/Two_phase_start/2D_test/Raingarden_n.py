...
# elementQuadrature = SimplexGaussQuadrature(nd,12)

# elementBoundaryQuadrature = SimplexGaussQuadrature(nd-1,6)

femSpaces = {
    0: C0_AffineLinearOnSimplexWithNodalBasis,
...
# exteriorElementBoundaryQuadrature = elementBoundaryQuadrature
...
#levelNonlinearSolver = KSP_petsc4py
