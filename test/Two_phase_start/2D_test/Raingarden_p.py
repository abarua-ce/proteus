...
permeability2  = (5.60*m_per_s_by_m_per_d)*viscosity/(gravity*density_water)  #m^2
...
dirichletConditions = {0:getDBC_2D_Richards_Shock, 1:getDBC_2D_Richards_Shock}
...
initialConditions  = {0:ShockIC_2D_Richards(), 1:ShockIC_2D_Richards()}
