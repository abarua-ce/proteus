...
if ct.STABILIZATION_TYPE in ['Galerkin', 'VMS']: #SUPG
    ...
    fullNewtonFlag = False
    updateJacobian = False
    timeIntegration = TADRI.RKEV # SSP33
...
numericalFluxType = TADRI.NumericalFlux
#numericalFluxType = DoNothing
#numericalFluxType = Advection_DiagonalUpwind_IIPG_exterior # PERIODIC

shockCapturing = TADRI.ShockCapturing(coefficients,nd,shockCapturingFactor=shockCapturingFactor_tadr,lag=lag_shockCapturing_tadr)
