#ifndef Richards_sat_H
#define Richards_sat_H
#include <cmath>
#include <iostream>
#include <valarray>
...
namespace proteus
{
  class Richards_sat_base
  {
    //The base class defining the interface
  public:
    virtual ~Richards_sat_base(){}
  ...
  class Richards_sat : public Richards_sat_base
  {
  public:
  ...
  inline Richards_sat_base* newRichards_sat(int nSpaceIn,
  ...
  {
    if (nSpaceIn == 1)
      return proteus::chooseAndAllocateDiscretization1D<Richards_sat_base,Richards_sat,CompKernel>(nSpaceIn,
      ...
      return proteus::chooseAndAllocateDiscretization2D<Richards_sat_base,Richards_sat,CompKernel>(nSpaceIn,
											   nQuadraturePoints_elementIn,
											   nDOF_mesh_trial_elementIn,
											   nDOF_trial_elementIn,
											   nDOF_test_elementIn,
      ...
      {
	assert(nSpaceIn == 3);
	return proteus::chooseAndAllocateDiscretization<Richards_sat_base,Richards_sat,CompKernel>(nSpaceIn,
											   nQuadraturePoints_elementIn,
											   nDOF_mesh_trial_elementIn,
											   nDOF_trial_elementIn,
											   nDOF_test_elementIn,
